...
[![](https://img.shields.io/github/actions/workflow/status/oxidvip/3x-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/oxidvip/3x-ui.svg)](#)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/oxidvip/3x-ui/master/install.sh) v2.4.3
```
